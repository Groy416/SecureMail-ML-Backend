...
CATALOG: tuple[dict[str, Any], ...] = (
    ...
    _entry(
        ...
        description="Deprecated TLS 1.0",
        risk_label="critical",
        anomaly_label=1,
        expected_finding_ids=["TLS-001"],
        tls={
            "version": "TLS1.0",
    ...
    _entry(
        ...
        family="cryptographic_weakness",
        description="3DES cipher suite",
        risk_label="critical",
        anomaly_label=1,
        expected_finding_ids=["TLS-002"],
        tls={
            "version": "TLS1.2",
            "cipher_suite": "TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA",
            "key_exchange": "ECDHE",
            "forward_secrecy": True,
            "signature_algorithm": "SHA1-RSA",
        },
